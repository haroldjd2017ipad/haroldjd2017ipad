...
-- INSERT A TOOL IN STARTERPACK NAMED "Lightning" AND EQUIP IT TO BE ABLE TO SUMMON A LIGHTING
...
game.ReplicatedStorage.Lightning.OnServerEvent:Connect(function(_,pos)
